...
const port = process.env.SERVER_PORT || process.env.PORT || 6100;        
const UUID = process.env.UUID || '817be517-da28-48cb-94a0-5b010ed517c1'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho12.joehy.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOGY5MTFhYmU5MDI3OTlmOGI0MjYzYTRmNTFhNTlmN2QiLCJ0IjoiYzYzNjhkNjYtMWE0Ni00YmUxLWI1OTctYjI3ODhjZjQ4YWYxIiwicyI6Ik5HVmpOR1ZsTm1FdE1qQmhaaTAwTkRNNExXRTROakF0TW1ReFpERmpNV1JrTmpsayJ9';
